...
const translations = {
  pt: {
    ...
    'gameTitle.runner': '🔥 Pula Fogueira Runner',
    'gameTitle.pamonha': '🌽 Ralador de Pamonha',
    'gameTitle.quentao': '🍷 Servir Quentão',
    'suffix.runner': 'pts',
    'suffix.pamonha': 'unid.',
    'suffix.quentao': 'seg.',
  ...
  en: {
    ...
    'hub.btnBack': '⬅ Back to Hub',
    'ranking.title': 'Medal Board',
    'ranking.empty': 'No games played yet',
    'ranking.place': ' Place',
    'game.runner': '🔥 Fire Jumper',
    'game.pamonha': '🌽 Corn Grater',
    'game.quentao': '🍷 Quentão',
    'gameTitle.runner': '🔥 Fire Jumper Runner',
    'gameTitle.pamonha': '🌽 Corn Grater',
    'gameTitle.quentao': '🍷 Drink Balancer',
    'suffix.runner': 'pts',
